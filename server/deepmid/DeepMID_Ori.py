...
if __name__ == "__main__":
    ...
    model_save_path = 'C:/Users/Lenovo/Desktop/DeepMID-main/model/model_1/'
    ...
    if bTrain:
        ...
        model = DeepMID([aug['R'].shape, aug['S'].shape], 8,0.0001)
        # DeepMID(xshapes, num_conv_layers-1)
        train_DeepMID(model, [aug['R'], aug['S']], aug['y'], 32, 20, [aug_valid['R'], aug_valid['S']], aug_valid['y'])
